      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/biteswithjasooni"
            ...
            <li>
              <a
                href="https://www.github.com/jasoonii"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
                <img src="/img/githubLogo.png" alt="GitHub Logo" width="32" height="32" />
              </a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/jasonddang/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
